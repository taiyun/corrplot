...
If using `"hclust"`, `corrplot()` can  draw rectangles around the chart of correlation matrix based on the results of  hierarchical clustering.

```{r rectangles}
# use namesMat parameter
r = rbind(c('gear', 'wt', 'qsec', 'carb'),
        c('wt', 'gear', 'carb', 'qsec'))
corrplot(M, order = "AOE") -> p1
corrRect(namesMat = r, corrRes = p1)

# use name parameter
corrplot(M, order = "AOE") -> p2
corrRect(name = c("gear", "wt", "carb"), corrRes = p2)
