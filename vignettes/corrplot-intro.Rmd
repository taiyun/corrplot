...
if(all(capabilities(c('cairo', 'X11')))){
...
n <- 100
m <- 10
DATASET <- matrix(runif(n * m), nrow = m, ncol = n)

# A 100x100 correlation matrix, tl.cex = 0.45
corrplot(cor(DATASET), method = "color", type = "upper",
         order = "FPC", tl.pos = "td", tl.cex = 0.45)
```
