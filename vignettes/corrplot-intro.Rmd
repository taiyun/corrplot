...
M <- cor(mtcars)
Mpval <- cor.mtest(mtcars)

corrplot(M, p.mat = Mpval, insig = "label_sig",
         sig.level = c(.001, .01, .05), pch.cex = .9, pch.col = "white")
corrplot(M, p.mat = Mpval, method = "color",
         insig = "label_sig", pch.col = "white")
corrplot(M, p.mat = Mpval, method = "color", type = "upper",
         sig.level = c(.001, .01, .05), pch.cex = .9,
         insig = "label_sig", pch.col = "white", order = "AOE")
corrplot(M, p.mat = Mpval, insig = "label_sig", pch.col = "white",
